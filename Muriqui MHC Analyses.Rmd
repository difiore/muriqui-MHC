...
# The dataframe "adults" contains information on individual heterozygosity (proportion of typed loci that are heterozygous) and number of MHC alleles. Here, we look at whether these are related.
...
# Load in summary of dissimilarity among all pairs of adults and merge with pairwise estimated R from {related}. The dissimilarity data is essentially a half matrix of dissimilarity among all dyads with NA added for any dyads involving 5 adult females who were not typed for MHC.
...
# There is a slight negative relationship here, with more closely related dyads being less dissimilary at the MHC.
```
