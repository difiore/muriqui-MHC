...
THE STUFF BELOW IS PLAYING AROUND ONLY
...
# what FF pairs are more likely to be FS than UR?
fs_vs_un_adult <- fs_vs_un_adult %>% filter(ind1.sex=="F", ind2.sex == "F", sig2 != "ns")

fs_vs_un_adult <- fs_vs_un_adult %>% filter(ind1.id %in% c("JU", "HE", "TZ", "YA", "PL", "FE", "GA") | ind2.id %in% c("JU", "HE", "TZ", "YA", "PL", "FE", "GA"))
...
# what FF pairs are more likely to be HS than UR?
hs_vs_un_adult <- hs_vs_un_adult %>% filter(ind1.sex=="F", ind2.sex == "F", sig2 != "ns")

hs_vs_un_adult <- hs_vs_un_adult %>% filter(ind1.id %in% c("JU", "HE", "TZ", "YA", "PL", "FE", "GA") | ind2.id %in% c("JU", "HE", "TZ", "YA", "PL", "FE", "GA"))
```
